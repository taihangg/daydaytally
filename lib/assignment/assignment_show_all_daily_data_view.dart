...
//            alignment: Alignment.bottomCenter,
  ...
  void _onReplenishReportCommit_setNum(
    ...
    if ((null == line1Num) || (null == line2Num)) {
      assert(false);
      return;
    }
  ...
  Widget _buildBody() {
    ...
    return Container(
      ...
      child: ListView.separated(
        itemCount: _allDailyDatas.length,
        padding: const EdgeInsets.all(16.0),
        itemBuilder: (BuildContext context, int index) {
          DailyData? dailyData = _getDailyData(index);
          // if (null != dailyData) {
          return _buildDataRow(
              sequenceStr: "${index + 1}:",
              date: dailyData!.date,
        ...
        separatorBuilder: (BuildContext context, int index) {
          return Container(
              height: 5,
              child: Divider(thickness: 0.3, color: Colors.deepPurpleAccent));
        },
      ),
    );
  }
