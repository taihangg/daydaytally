...
//  String _quality;
  ...
  late String _city;
  late List<_WeatherDataDay> _days;

  static WeatherData parse(
      String? fullCityName, String? cityCode, String body) {
    ...
    WeatherData weatherData = weatherData_tianqiapi.convert2WeatherData();
    // if (null != weatherData) {
...
//    final DateInt todayInt = DateInt(DateTime.now());
    ...
    for (final d in _days) {
      ...
      if (20 < weatherData.dates.length) {
        break;
      }
    }
