...
class TodoView extends StatefulWidget {
  ...
  TodoView({required this.width, required this.onStatusChangeFn}) {}
...
class ExpansionTileRoot extends StatelessWidget {
  ...
  ExpansionTileRoot({
    required this.width,
    required this.entryRoot,
    required this.onStatusChangeFn,
    required this.onTaskEntrySelectedFn,
  });
...
class TodoActionBar extends StatelessWidget {
  ...
  late final Function() onDeleteTaskFn;
