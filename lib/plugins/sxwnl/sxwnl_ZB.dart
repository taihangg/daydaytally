...
//  #region 公共属性(注: 初始转换时为字段, 已改写为自动实现的属性)
  ...
  /// 黄经章动
  /// </summary>
  static late double dL; //{ get; set; }    // = 0;

  /// <summary>
  /// 交角章动
  /// </summary>
  static late double dE; //{ get; set; }    // = 0;

  /// <summary>
  /// 保存空间两点连线与地球的交点: 经(?)
  /// </summary>
  static late double le_J; //{ get; set; }    // = 0;

  /// <summary>
  /// 保存空间两点连线与地球的交点: 纬(?)
  /// </summary>
  static late double le_W; //{ get; set; }    // = 0;

  /// <summary>
  /// (?)
  /// </summary>
  static late double le_R1; //{ get; set; }    // = 0;
