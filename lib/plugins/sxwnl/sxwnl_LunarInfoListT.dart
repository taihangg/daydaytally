...
//#region 公共属性(注: 初始转换时为公共字段, 已改写)
  ...
  late double s__; // 升(时间)
  late double z__; // 中(时间)
  late double j__; // 降(时间)
  late double c__; // 晨(时间)
  late double h__; // 昏(时间)
  late double ch__; // 晨昏差(时间)
  late double sj__; // 升降差(时间)
  late String s; // 升(时间串)
  late String z; // 中(时间串)
  late String j; // 降(时间串)
  late String c; // 晨(时间串)
  late String h; // 昏(时间串)
  late String ch; // 日照时间(串)
  late String sj; // 昼长(时间串)
  late String Ms; // 月出时间(串)
  late String Mz; // 月亮中天时间(串)
  late String Mj; // 月落时间(串)
  ...
  late double H; // 指定时刻的天体时角
  late double H0; // 本属性(字段)有不同的含义： 升起对应的时角(月亮?), 或地平以下50分的时角(太阳?)
  late double H1; // 地平以下6度的时角(太阳?)
  late double pe1; // 节气的儒略日
  late double pe2; // 节气的儒略日
