...
//  #region 转换时增加的私有字段(用于封装成公共属性, 按转换规范 10 命名)
  ...
  static List<String> ym = List.filled(32, ""); //各月名称
  static LunarInfoListT<double> ZQ = new LunarInfoListT<double>.withData(
      31, 0); //中气表,其中.liqiu是节气立秋的儒略日,计算三伏时用到
  static List<double> HS = List.filled(32, 0.0); //合朔表
  static List<double> dx = List.filled(32, 0.0); //各月大小
  static List<double> Yn = List.filled(1, 0.0); //年计数
