...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.example.android_external_storage.AndroidExternalStoragePlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin android_external_storage, com.example.android_external_storage.AndroidExternalStoragePlugin", e);
    }
    try {
